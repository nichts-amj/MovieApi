...
class FlimListPage extends StatefulWidget {
  const FlimListPage({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _FlimListPageState createState() => _FlimListPageState();
}

class _FlimListPageState extends State<FlimListPage> {
  List listData = [];
            ...
            return Container(
              ...
              child: ListTile(
                ...
                subtitle:
                    ...
                    Text("Release Date: " + listData[index]['release_date']),
              ),
            );
          },
        ),
